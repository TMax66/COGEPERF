...
```{r echo=FALSE}
library(fs)
dir_tree(path = "C:/Users/vito.tranquillo/Desktop/Git Projects/COGEPERF", recurse = FALSE)
```
...
3. **_conSB_**: Al database _ObiettiviStrategici2022_ per i dati relativi alla distribuzione dei FTE programmati
...
La voce Fatturato è  raggruppata per ANNO, Dipartimento, Reparto, Laboratorio e quindi sommata.
